import { $ as unknown, B as boolean, F as EventSourceParserStream, G as looseObject, I as _enum, J as object, N as WORKFLOW_DESERIALIZE, P as WORKFLOW_SERIALIZE, Q as union, W as literal, Y as record, Z as string, et as safeParseAsync, q as number, st as ZodFirstPartyTypeKind, tt as toJSONSchema, z as array } from "./gateway+[...].mjs";
...
var getFromApi = async ({ url, headers = {}, successfulResponseHandler, failedResponseHandler, abortSignal, fetch = getOriginalFetch$1(), validateUrl, credentialedOrigin, trustedOrigin }) => {
	try {
...
function loadApiKey({ apiKey, environmentVariableName, apiKeyParameterName = "apiKey", description }) {
	...
	if (typeof processModule === "undefined") throw new LoadAPIKeyError({ message: `${description} API key is missing. Pass it using the '${apiKeyParameterName}' parameter. Environment variables are not supported in this environment.` });
	apiKey = processModule.env[environmentVariableName];
