...
//#region src/lib/roadmap.functions.ts?tss-serverfn-split
...
var updateModuleProgress = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((input) => z.object({
...
async function generateRoadmapInternal(context) {
	...
	const model = createGoogleGenerativeAI({ apiKey })("gemini-3.5-flash");
