...
async function resolvePDFJSImport(pdfjsResolver, { reload = false } = {}) {
	...
	try {
		resolvedModule = await import("./pdfjs-BuyIzMva.js");
	} catch (error) {
...
async function renderPageAsImage$1(data, pageNumber, options = {}) {
	...
	if (options.toDataURL) return dataUrl;
...
async function getMeta$1(data, options = {}) {
	const meta = await (isPDFDocumentProxy(data) ? data : await getDocumentProxy(data)).getMetadata();
